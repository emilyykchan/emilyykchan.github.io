...
<style>
  ...
  .photo-diary-image-wide {
    max-width: 900px;
  }

  .photo-diary-image img {
    width: 100%;
    max-height: 560px;
    object-fit: cover;
    border-radius: 10px;
...
This was not the place we set out to visit, but perhaps that made it more memorable. Lyveden felt quiet, unfinished, and slightly unexpected — a winter detour that turned into a very good National Trust day.
