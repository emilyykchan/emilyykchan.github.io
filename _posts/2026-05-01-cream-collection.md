...
tags: cats photos gallery images
categories: out-of-office
thumbnail: assets/img/posts/cream-collection/cream-cover.jpeg
toc:
  sidebar: left
images:
  slider: true
...
Cream is a small cat with a very large personality. This page is a photo collection of his many moods: sleepy, handsome, mischievous, curious, and quietly observant.
...
<swiper-container class="cream-slider" keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true">
  ...
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/img/posts/cream-collection/nap-baywindow.jpeg" class="img-fluid rounded z-depth-1" %}</swiper-slide>
...
## Grooming
Bathing, brushing, tidying up, and maintaining standards.

## Furmidable
Cream with his humans: affectionate, demanding, clingy, or commanding.
-->
